      ...
      <div class="container  py-2 px-2">
        <div class="container rounded bg-white">
            <div class="px-3 py-3 bg-white">
              <strong><a href="index.php">All Colleges</a> / <span class="maroon">College of Business Administration and Accountacy (Ba&A)</span></strong>
            </div>
            <div class="px-3 py-3">
              <?php include('data/ba_data.php'); ?>
            </div>
        </div>
      </div>
  </div>

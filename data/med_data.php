...
$sql = "SELECT
        ...
        WHERE
        c.college_name = 'College of Medicine'
        GROUP BY 
        d.department_name
        ORDER BY 
        d.department_name";
                        ...
                        <div class="row">
                            ...
                            <div class="col custom-column">
                                <div class="container-custom">
                                    ...
                                    <h5  class="mt-0"><span class="modaltext-two">${rankFullName}</span><span class="fw-lighter modaltext-two">, ${departmentNewName}, COM</span></h5>
                                    <hr>

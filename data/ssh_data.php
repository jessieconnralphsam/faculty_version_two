...
$sql = "SELECT
        ...
        WHERE
        c.college_name = 'College of Social Sciences and Humanities'
        GROUP BY 
        d.department_name
        ORDER BY 
        d.department_name";
        ...
        containers.forEach(container => {
            container.addEventListener('click', function () {
                ...
                const departmentMap ={
                    ...
                    "Department of Filipino" : "Filipino",
                    "Department of History" : "History",
                    "Department of Islamic Studies": "Islamic Studies",
                    "Department of Political Science" : "PolSci",
                    "Department of Sociology" : "Sociology",
                    "Pre-University/College Bound Program" : "CBP"
                };
                        ...
                        <div class="row">
                            ...
                            <div class="col custom-column">
                                <div class="container-custom">
                                    ...
                                    <h5  class="mt-0"><span class="modaltext-two">${rankFullName}</span><span class="fw-lighter modaltext-two">, ${departmentNewName}, CSSH</span></h5>
                                    <hr>

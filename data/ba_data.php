...
$sql = "SELECT
        ...
        WHERE
        c.college_name = 'College of Business Administration and Accountacy'
        GROUP BY 
        d.department_name
        ORDER BY 
        d.department_name";
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="container w-auto p-3">
                                    ...
                                    <h5  class="modaltext mt-3"><strong>${rankFullName}, ${department}, Ba&A</strong></h5 >
                                    <hr>
                                    ...
                                    <p class="footer-text mt-0 mb-0">College of Business Administration and Accountacy</p>

...
$sql = "SELECT
        ...
        WHERE
        c.college_name = 'College of Fisheries'
        GROUP BY 
        d.department_name
        ORDER BY 
        d.department_name";
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        containers.forEach(container => {
            container.addEventListener('click', function () {
                ...
                const departmentMap ={
                    "Department of Aquaculture" : "Aquaculture"
                };
                        ...
                        <div class="row">
                            ...
                            <div class="col custom-column">
                                <div class="container-custom">
                                    ...
                                    <h5  class="mt-0"><span class="modaltext-two">${rankFullName}</span><span class="fw-lighter modaltext-two">, ${departmentNewName}, COF</span></h5>
                                    <hr>
